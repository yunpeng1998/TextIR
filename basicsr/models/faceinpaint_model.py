...
class FaceInpaintingModel(BaseModel):
    """StyleGAN2 model."""

    def __init__(self, opt):
        super(FaceInpaintingModel, self).__init__(opt)
    ...
    def optimize_parameters(self, current_iter):
        ...
        fake_img, _ = self.net_g(self.lq, self.cond)
    ...
    def test(self):
        self.net_g_ema.eval()
        self.output, _ = self.net_g_ema(self.lq, self.cond)
    ...
    def eval_net(self, current_iter):
        self.test()
        save_name = 'iter' + str(current_iter) + '.jpg'
